...
public class NestedLoops {
    public static void main(String[] args) {
        ...
        /*
                   arr2D[0][0]'A'      arr2D[1][0]'C'       arr2D[2][0]'F'
                   arr2D[0][1]'B'      arr2D[1][1]'D'       arr2D[2][1]'J'
                                       arr2D[1][2]'E'       arr2D[2][2]'H'
                                                            arr2D[2][3]'I'
         */
 ...
 // arr2D[1]======> {'C','D','E'}
  ...
  for (int j=0;j<arr2D.length;j++){ // j: index number of 1D array.  i: index number of element
