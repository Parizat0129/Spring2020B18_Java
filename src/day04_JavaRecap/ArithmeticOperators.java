    ...
    public static void main(String[] args) {
     ...
     int a=10/3; //3
      ...
      //float fi==2;
        ...
        //            1==0===>false
        //if 25/2 has reminder of zero, then it's even number
        System.out.println(evenNumber);//false
        System.out.println(25%2);

        boolean oodNumber = 22%2 !=0;//ood num
         //                 0 != 0 ====>false
        System.out.println(oodNumber);
        ...
        System.out.println("25 in odd number: "+(25%2!=0));
